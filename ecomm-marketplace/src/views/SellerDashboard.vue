<template>
  <div>
    ...
    <div class="seller-dashboard-container">
      <aside class="sidebar">
        <ul>
          <li @click="selectedTab = 'manageProducts'; fetchProducts()">Manage Products</li>
  ...
  setup() {
    ...
    const sellerProducts = computed(() => {
      if (!authStore.user || !authStore.user.email) {
        console.warn("User email not found in authStore!");
        return [];
      }
      
      console.log("Seller Email:", authStore.user.email);
      const filteredProducts = products.value.filter(product => product.seller.email === authStore.user.email);
    ...
    return { products, sellerProducts, selectedTab, newProduct, fetchProducts, addProduct, deleteProduct, handleFileUpload };
  },
};
</script>
